...
const CTA = () => {
  ...
  return (
    <section className="py-16 rounded-lg text-center px-4">
      <h2 className="text-5xl font-bold mb-4 bg-gradient-to-r from-primary to-tertiary bg-clip-text text-transparent uppercase font-heading">¿LISTO PARA TRANSFORMAR TU PRESENCIA DIGITAL?</h2>
